...
export const NavBar = () => {
  ...
  return (
    <>
      ...
      <nav className="sticky top-0 z-50 h-18 border-b border-zinc-200 bg-white">
        <div className="mx-auto flex h-full items-center justify-between px-4 md:px-8 lg:px-16">
          {/* Left */}
          <div className="flex items-center gap-4">
            ...
            >
              <span
                className={clsx(
                  "block h-0.5 w-6 bg-zinc-800 transition-all duration-300",
      ...
      <div
        className={clsx(
          "fixed left-0 top-18 z-50 h-[calc(100vh-72px)] w-72 bg-white shadow-xl transition-transform duration-300",
